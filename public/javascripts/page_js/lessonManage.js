    ...
    _const.prototype = {
        ...
        _setlessonIDList: function(strJson) {
            ...
            $.each(strJson, function(i, v) {
                ...
                //詳細資料
                _input = $("<span />", {
                    "class": "label label-success btn-embossed",
                    "text": "編輯",
                    "style": "font-size:100%;"
                });
                ...
                _td.append(_input)
                _input = $("<span />", {
                    "class": "label label-default btn-embossed",
                    "text": "聯絡人資訊",
                    "style": "margin-left:10px;font-size:100%;"
                });
                _input.bind("click", function() {
        ...
        _setAllPassLesson: function(data) {
            ...
            $.each(data, function(i, v) {
                ...
                //刪除
                _input = $("<span />", {
                    "class": "label label-danger btn-embossed",
                    "text": "刪除",
                    "style": "margin-left:10px;font-size:100%;"
                });
                _input.bind("click", function() {
            ...
            $.ajax({
                ...
                success: function(datas) {
                    ...
                    if (data == "no repeat") {
                        ...
                        layer.msg('<b>課程名稱重複</b>', {
                            time: 1500,
                            icon: 2,
                            shade: [0.5, 'black']
                        });
                    } else if (data == "abbrRepeat") {
                        layer.msg('<b>課程縮寫重複</b>', {
                            time: 1500,
                            icon: 2,
                            shade: [0.5, 'black']
                        });
            ...
            $.ajax({
                ...
                success: function(datas) {
                    if (datas.success == 'yes') {
                        ...
                        layer.msg('<b>變更課程失敗：時間及地點衝突</b>', {
                            time: 1500,
                            icon: 2,
                            shade: [0.5, 'black']
                        });
                    } else {
                        layer.msg('<b>變更課程失敗：沒有任何改變</b>', {
                            time: 1500,
                            icon: 2,
                            shade: [0.5, 'black']
                        });
            ...
            $.ajax({
                ...
                success: function(datas) {
                    if (datas.success == 'yes') {
                        ...
                        layer.msg('<b>已有相同的課程名稱及聯絡人</b>', {
                            time: 1500,
                            icon: 2,
                            shade: [0.5, 'black']
                        });
                    } else {
                        layer.msg('<b>已有相同的課程縮寫</b>', {
                            time: 1500,
                            icon: 2,
                            shade: [0.5, 'black']
                        });
